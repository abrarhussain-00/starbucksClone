        ...
        <div>
            <div>
                ...
                <div className="flex">
                    <MenuSideNav />
                    <div>
                        <p className='text-start'><a href="/menu">Menu / </a><span className='font-bold' style={{ color: 'gray' }}>Frappuccino® Blended Beverages</span></p>
                        <br />
                        <p className='font-bold text-start text-[30px]'>Frappuccino® Blended Beverages</p>
                        <br /><br />
                        <div>
                            <p className='font-bold text-start text-[24px]'>Coffee Frappuccino®</p>
                            ...
                            <div className="text-center gap-10 grid grid-cols-4 ">
                                ...
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Mocha Cookie <br /> Crumble <br /> Frappuccino® </span>
                                ...
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Caramel Ribbon <br /> Crunch <br /> Frappuccino® <br /> Blended <br /> Beverage</span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Espresso <br /> Frappuccino® <br /> Blended <br /> Beverage </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Caffè Vanilla <br /> Frappuccino® <br /> Blended <br />Beverage </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                ...
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Coffee <br /> Frappuccino® <br /> Blended <br />Beverage </span>                                
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Mocha <br /> Frappuccino® <br /> Blended <br />Beverage </span> 
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Java Chip <br /> Frappuccino® <br /> Blended <br /> Beverage</span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>White Chocolate <br /> Mocha <br /> Frappuccino® <br /> Blended <br /> Beverage </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                            </div>
                        </div>
                        <br /><br />
                        <div>
                            <p className='font-bold text-start text-[24px]'>Creme Frappuccino®</p>
                            <hr style={{ height: '1px', background: 'gray', width: '100%' }} />
                            <br /><br />
                            <div className="text-center gap-10 grid grid-cols-4 ">
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Chocolate Mint <br /> Crème <br /> Frappuccino® <br /> Blended <br /> Beverage </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    <img src="https://globalassets.starbucks.com/assets/1fd99578d31f4072a52892398d8f1fa8.jpg?impolicy=1by1_wide_topcrop_630" width={150} className="rounded-full mr-2" />
                                    <br />
                                    <span className='text-center'>Chocolate <br /> Cookie Crumble <br /> Crème <br /> Frappuccino® </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    <img src="https://globalassets.starbucks.com/assets/22f8e0db2106468d953bce434f5328a3.jpg?impolicy=1by1_wide_topcrop_630" width={150} className="rounded-full mr-2" />
                                    <br />
                                    <span className='text-center'>Caramel Ribbon <br /> Crunch Crème <br /> Frappuccino® <br /> Blended <br /> Beverage </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Strawberry <br /> Crème <br /> Frappuccino® <br /> Blended <br /> Beverage </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Chai Crème <br /> Frappuccino®</span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Double <br /> Chocolaty Chip <br /> Crème <br /> Frappuccino® <br /> Blended </span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Matcha Crème <br /> Frappuccino® <br /> Blended <br /> Beverage</span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>Vanilla Bean <br /> Crème <br /> Frappuccino® <br /> Blended Crème</span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                                <a href="#" className="items-center">
                                    ...
                                    <br />
                                    <span className='text-center'>White Chocolate <br /> Crème <br /> Frappuccino® <br /> Blended Beverage</span>
                                    <div className='font-bold'>🚫 Not available</div>
                                </a>
                            </div>
                        </div>
